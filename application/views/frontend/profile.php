...
<html lang="zxx" class="no-js">
	...
	<body>
		...
		<section class="generic-banner relative section-gap bg-12 ">
			<div class="container">
						...
						<div class="col-lg-6">
							...
							<div class="card" align="left">
								<div class="card-header">
									<i class="fas fa-user"></i> Profil detayları
								</div>
								<div class="card-body" align="left">
									<div class="row">
										<div class="col-sm-8">
											<h5 class="card-title">TC Numarası</h5>
										...
										<div class="col-sm-14">
											...
											<p><a href="<?php echo base_url('profile/changepassword/'.$profile['kd_pelanggan']) ?>" class="btn btn-primary">Şifre değiştir</a></p>
											<p><button data-toggle="modal" data-target="#exampleModal" class="btn btn-primary">Profili Düzenle</button></p>
										</div>
									</div>
								</div>
							</div>
										...
										<div class="row">
											<div class="col-sm-14">
												<div class="row form-group">
													<label for="nama" class="control-label">TC Numarası</label>
