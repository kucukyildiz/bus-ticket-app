								...
								<form action="<?php echo base_url() ?>login/daftar" method="post">
									...
									<div class="form-group">
										<div class="form-row">
											<div class="col-md-6">
												<div class="form-label-group">
													<input type="text" name="email" class="form-control" required="" placeholder="E-posta" value="<?php echo set_value('email') ?>">
									...
									<button class="btn btn-info btn-block">Üye Ol</button>
								</form>
								<hr>
								<div class="text-center">
									<p>Kayıtlı? <a class="" href="<?php echo base_url() ?>login">Şimdi giriş yap</a></p>
								</div>
							</div>
						</div>
					</div>
