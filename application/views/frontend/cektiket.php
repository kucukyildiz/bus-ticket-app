					  ...
					  <div class="card-body">
					    <form action="<?php echo base_url() ?>tiket/cekorder" method="post">
									<div class="form-group">
										...
										<input type="text" id="" class="form-control" id="" name="kodetiket" placeholder="Bilet PNR" required="">
									</div>
									<button type="submit" class="btn btn-success pull-right">Sorgula</button>
								</form>
					  </div>
					</div>
					</div>
