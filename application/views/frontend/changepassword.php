...
<html lang="zxx" class="no-js">
	...
	<body>
		...
		<section class="generic-banner relative section-gap bg-12 h-100vh">
			<div class="container">
									...
									<form ction="<?php echo base_url('profile/changepassword') ?>" method="post">
									 <?php echo $this->session->flashdata('gagal'); ?>
									  <div class="form-group">
									    ...
									    <input type="password" class="form-control"  name="currentpassword" placeholder="Eski Şifre">
									  ...
									  <div class="form-group">
									  	<div class="form-label md-5">
									    <input type="password" class="form-control" required="" name="new_password2" placeholder="Şifreyi tekrar girin">
										</div>
									  </div>
									<a class="btn btn-danger" href="<?php echo base_url() ?>profile/profilesaya/<?php echo $this->session->userdata('kd_pelanggan') ?>">Geri git</a>
									<button type="submit" class="btn btn-primary pull-right" >Şifre değiştir</button>
									</form>
								</div>
							</div>
						</div>
