...
<html lang="zxx" class="no-js">
	...
	<body>
		...
		<section class="service-area section-gap relative h-100vh bg-12">
							...
							<div class="card-body">
								...
								<table class="table table-bordered table-hover table-striped">
									<thead class="thead-dark">
										<tr>
											<th scope="col">Rota [seyahat Kodu]</th>
											<th>Varış terminalı</th>
									...
									<tbody>
										...
										<tr>
											...
											<td>TL<?php echo number_format((float)($jadwal[$i]['harga_jadwal']),0,",","."); ?></td>
											<td><a href="<?php echo base_url('tiket/beforebeli/').$jadwal[$i]['kd_jadwal'].'/'.$asal['kd_tujuan'].'/'.$tanggal ?>" class=" btn btn-outline-success">Seç</a></td>
										</tr>
										<?php } ?>
									</tbody>
								</table>
